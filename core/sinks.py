...
def construir_factura_y_pago(t: "TransaccionComercial"):
    """
...
def encolar_impresion(t: "TransaccionComercial", cola, ancho: int = 42) -> None:
    ...
    factura, pago = construir_factura_y_pago(t)
...
def generar_xlsx(t: "TransaccionComercial"):
    """
    Genera el archivo Excel de factura y retorna su ruta.
    Adapter entre TransaccionComercial y generar_factura_xlsx().
    """
    from src.factura_writer import generar_factura_xlsx

    factura, _ = construir_factura_y_pago(t)
    return generar_factura_xlsx(factura)
