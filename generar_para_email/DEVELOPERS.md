...
└─ templates/
   └─ index.html ................. UI y handlers JS
       ├─ Botones: btn-cerrar-dia, btn-cerrar-mes
       ├─ Modales: cierre-mes-modal, cierre-dia-modal
       ├─ JS: btnCierreMes.addEventListener(), guardarCierreEnCarpeta()
       └─ Fallback: descarga automática si no hay carpeta
...
### Sistema Viejo: Botones (línea 139-142)

```html
<button id="btn-cerrar-dia" class="ghost">Cerrar día</button>
...
<button id="btn-carpeta-cierres-dia" class="ghost"
        title="Seleccionar carpeta...">
  📁 Seleccionar carpeta (Cierres día)
</button>
```
